...
Description
	B% Version-2.2 delivers the functionality necessary to support the example
	...
	A final, functional implementation of the design can be found under
	...
	all reading the ./Examples/6_System/TM.system file to eventually
	deliver yet another Turing Machine implementation
...
New Features and Additions
   ...
   15. narrative subclassing and post-frame narrative
	...
	base class supercedes both main and post-frame narratives
	'en' command is not allowed in post-frame narrative

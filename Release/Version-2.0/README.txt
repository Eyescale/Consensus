...
New Features and Extensions
  New Features
	...
	modulo the changes mentioned in the Changes and Extensions section below
  ...
  New Feature Description
	...
	instance created, and manifested, but with nothing to show for it - not
	even via on ~((*,handle),?)
	...
	The following B% narrative occurrence causes B% to pause execution
	...
	B% Version-2.0 requires the following syntax to be used
	...
	the narrative's parent connection to be used, provided parent did not
	unsubscribe from child at inception - see above New operator section

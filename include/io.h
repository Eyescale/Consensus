...
void	io_notify( CNLog *log, _context *context );
...
void	io_flush( int fd, int *remainder, int eod, _context *context );
int	io_finish( int fd, int *remainder, int eot, _context *context );
